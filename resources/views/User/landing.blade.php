...
@section('title', 'LAPOR PAK! - Pengaduan Masyarakat')
...
<section class="header">
        ...
        <div class="container">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">
                    <h4 class="semi-bold mb-0 text-white">CAK MANO!</h4>
                    <p class="italic mt-0 text-white">Laporkan Sini be!!</p>
                </a>
    ...
    <div class="text-center">
        <h2 class="medium text-white mt-3">Layanan Konsultan dan Kerusakan Alat</h2>
        <p class="italic text-white mb-5">Sampaikan laporan Anda langsung kepada yang bersangkutan</p>
    </div>
            ...
            <form action="{{ route('pekat.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <input type="text" value="{{ old('tgl_kejadian') }}" name="tgl_kejadian"
                        placeholder="Pilih Tanggal" class="form-control" onfocusin="(this.type='date')"
                ...
                <div class="form-group">
                    <div class="input-group mb-3">
                        <select name="kategori_kejadian" class="custom-select" id="inputGroupSelect01" required>
                            ...
                            <option value="agama">Kerusakan</option>
                            <option value="hukum">Konsultasi</option>
                            <option value="lingkungan">Penggantian</option>
                            <option value="sosial">Lainnya</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
...
<div class="mt-5">
    <hr>
    <div class="text-center">
        <p class="italic text-secondary">© 2022 StaffQ • All rights product</p>
    </div>
</div>
{{-- Modal --}}
